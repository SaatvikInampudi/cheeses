...
---
title: "Final Project: Exploratory Data Analysis on Cheeses"
format: html
editor: visual
---
...
For the initial analysis, the following strategies were employed to handle missing data:
	1.	Removal of Incomplete Cases:
	•	Rows with missing values in critical variables such as fat_content were removed to maintain data integrity.
	2.	Imputation of Missing Values:
	•	For variables where missing values were minimal, imputation techniques such as filling with the median were considered.
	•	Example: Imputing missing calcium_content with the median value of the available data.
